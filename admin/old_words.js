...
systemDictionary = {
	...
	"Log status messages": {
		"en": "Log status messages",
		"de": "Statusnachrichten protokollieren",
		"ru": "Журнал сообщений о состоянии",
		"pt": "Mensagens de status de log",
		"nl": "Log status berichten",
		"fr": "Journal des messages d'état",
		"it": "Registra i messaggi di stato",
		"es": "Registrar mensajes de estado",
		"pl": "Zaloguj komunikaty o stanie",
		"zh-cn": "记录状态消息"
	}
};